...
This tool provides AI-generated feedback and should be used as guidance, not as a definitive evaluation.h resume to a job description  
- Return a match summary and score  
- Clean and simple Bootstrap-based UI  
